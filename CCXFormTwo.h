...
@interface CCXFormTwo : UIViewController<UIPopoverControllerDelegate, UITextFieldDelegate, UIAlertViewDelegate>
{
...
@property (strong, nonatomic) UIImage *cig_pt_sign;
@property (strong, nonatomic) UIImage *cig_representative_sign;
