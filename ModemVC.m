...
-(NSString*)jsonString{
    ...
    for (NSDictionary *saveDict in arr_addedItems) {
        ...
        if ([saveDict valueForKey:@"quantity"] != nil) {
            ...
            NSString *machine_id = [saveDict valueForKey:@"modem_id"];
            NSString *machine_name = [saveDict valueForKey:@"modem_name"];
            
            
            
            NSString *item = [NSString stringWithFormat:@"{\"modem_id\": \"%@\",\"modem_name\": \"%@\",\"quantity\": \"%@\"}", machine_id, machine_name, item_quantity];
...
//    [self saveData];
//    NSString *modemData = [self jsonString];
//
...
//        NSLog(@"RT_ID: %@", RT_ID);
//        NSDictionary *dicti =[object_STV submitInventoryOfRT:RT_ID
//                                                machinesJson:self.json_machines
...
-(IBAction)showNextView{
    ...
    MaskVC *maskVc = [self.storyboard instantiateViewControllerWithIdentifier:@"MAK"];
    maskVc.json_humidifiers = self.json_humidifiers;
    maskVc.json_machines    = self.json_machines;
    maskVc.json_modem       = json;
...
-(void)responseDataOfDropdowns:(TicketFormModel*)object{
    self.arr_rt_modem_listing = object.arr_rt_modem_listing ;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tagNum == 11 || tagNum == 21 || tagNum == 31 || tagNum == 41 || tagNum == 51 || tagNum == 61 || tagNum == 71 || tagNum == 81 || tagNum == 91 || tagNum == 101)
    {
        ...
        NSString *manufacturer              = cellDict[@"item_id"];
        switch (tagNum) {
            case 11:{
                txt_1_modem.text = machine;
//                txt_1_manufacture.text = manufacturer;
//                txt_1_quantity.enabled = YES;
//                [txt_1_quantity becomeFirstResponder];
//                [dict_1 setObject:machine forKey:@"modem_name"];
//                [dict_1 setObject:cellDict[@"item_id"] forKey:@"modem_id"];
//                [self getSerialNumbersOfModem:cellDict[@"item_id"] tag:tagNum];
            ...
            case 21:{
                txt_2_modem.text = machine;
//                txt_2_manufacture.text = manufacturer;
//                txt_2_quantity.enabled = YES;
//                [txt_2_quantity becomeFirstResponder];
//                [dict_2 setObject:machine forKey:@"modem_name"];
//                [dict_2 setObject:cellDict[@"item_id"] forKey:@"modem_id"];
//                [self getSerialNumbersOfModem:cellDict[@"item_id"] tag:tagNum];
            ...
            case 31:{
                txt_3_modem.text = machine;
//                txt_3_manufacture.text = manufacturer;
//                txt_3_quantity.enabled = YES;
//                [txt_3_quantity becomeFirstResponder];
//                [dict_3 setObject:machine forKey:@"modem_name"];
//                [dict_3 setObject:cellDict[@"item_id"] forKey:@"modem_id"];
//                [self getSerialNumbersOfModem:cellDict[@"item_id"] tag:tagNum];
            ...
            case 41:{
                txt_4_modem.text = machine;
//                txt_4_manufacture.text = manufacturer;
//                txt_4_quantity.enabled = YES;
//                [txt_4_quantity becomeFirstResponder];
//                [dict_4 setObject:machine forKey:@"modem_name"];
//                [dict_4 setObject:cellDict[@"item_id"] forKey:@"modem_id"];
//                [self getSerialNumbersOfModem:cellDict[@"item_id"] tag:tagNum];
            ...
            case 51:{
                txt_5_modem.text = machine;
//                txt_5_manufacture.text = manufacturer;
//                txt_5_quantity.enabled = YES;
//                [txt_5_quantity becomeFirstResponder];
//                [dict_5 setObject:machine forKey:@"modem_name"];
//                [dict_5 setObject:cellDict[@"item_id"] forKey:@"modem_id"];
//                [self getSerialNumbersOfModem:cellDict[@"item_id"] tag:tagNum];
            ...
            case 61:{
                txt_6_modem.text = machine;
//                txt_6_manufacture.text = manufacturer;
//                txt_6_quantity.enabled = YES;
//                [txt_6_quantity becomeFirstResponder];
//                [dict_6 setObject:machine forKey:@"modem_name"];
//                [dict_6 setObject:cellDict[@"item_id"] forKey:@"modem_id"];
//                [self getSerialNumbersOfModem:cellDict[@"item_id"] tag:tagNum];
            ...
            case 71:{
                txt_7_modem.text = machine;
//                txt_7_manufacture.text = manufacturer;
//                txt_7_quantity.enabled = YES;
//                [txt_7_quantity becomeFirstResponder];
//                [dict_7 setObject:machine forKey:@"modem_name"];
//                [dict_7 setObject:cellDict[@"item_id"] forKey:@"modem_id"];
//                [self getSerialNumbersOfModem:cellDict[@"item_id"] tag:tagNum];
            ...
            case 81:{
                txt_8_modem.text = machine;
//                txt_8_manufacture.text = manufacturer;
//                txt_8_quantity.enabled = YES;
//                [txt_8_quantity becomeFirstResponder];
//                [dict_8 setObject:machine forKey:@"modem_name"];
//                [dict_8 setObject:cellDict[@"item_id"] forKey:@"modem_id"];
//                [self getSerialNumbersOfModem:cellDict[@"item_id"] tag:tagNum];
            ...
            case 91:{
                txt_9_modem.text = machine;
//                txt_9_manufacture.text = manufacturer;
//                txt_9_quantity.enabled = YES;
//                [txt_9_quantity becomeFirstResponder];
//                [dict_9 setObject:machine forKey:@"modem_name"];
//                [dict_9 setObject:cellDict[@"item_id"] forKey:@"modem_id"];
//                [self getSerialNumbersOfModem:cellDict[@"item_id"] tag:tagNum];
            ...
            case 101:{
                txt_10_modem.text = machine;
//                txt_10_manufacture.text = manufacturer;
//                txt_10_quantity.enabled = YES;
//                [txt_10_quantity becomeFirstResponder];
//                [dict_10 setObject:machine forKey:@"modem_name"];
//                [dict_10 setObject:cellDict[@"item_id"] forKey:@"modem_id"];
//                [self getSerialNumbersOfModem:cellDict[@"item_id"] tag:tagNum];
            }
                break;
...
-(void)getSerialNumbersOfModem:(NSString*)machineID tag:(int)tag{
...
-(void)selectOne:(UIButton*)sender{
    self.arr_dropdown = self.arr_rt_modem_listing;
