...
-(void)viewWillAppear:(BOOL)animated{
    ...
    txt_1_machine.text = @"";
    txt_1_manufacture.text = @"";
    txt_1_quantity.text = @"";
    
    txt_2_machine.text = @"";
    txt_2_manufacture.text = @"";
    txt_2_quantity.text = @"";
    
    txt_3_machine.text = @"";
    txt_3_manufacture.text = @"";
    txt_3_quantity.text = @"";
    
    txt_4_machine.text = @"";
    txt_4_manufacture.text = @"";
    txt_4_quantity.text = @"";
    
    txt_5_machine.text = @"";
    txt_5_manufacture.text = @"";
    txt_5_quantity.text = @"";
    
    txt_6_machine.text = @"";
    txt_6_manufacture.text = @"";
    txt_6_quantity.text = @"";
    
    txt_7_machine.text = @"";
    txt_7_manufacture.text = @"";
    txt_7_quantity.text = @"";
    
    txt_8_machine.text = @"";
    txt_8_manufacture.text = @"";
    txt_8_quantity.text = @"";
    
    txt_9_machine.text = @"";
    txt_9_manufacture.text = @"";
    txt_9_quantity.text = @"";
    
    txt_10_machine.text = @"";
    txt_10_manufacture.text = @"";
    txt_10_quantity.text = @"";
...
//    humVc.json_machines = json;
    MachinesVC *humVc = [self.storyboard instantiateViewControllerWithIdentifier:@"MAVC"];
    humVc.json_machines = json;
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (tagNum == 12 || tagNum == 22 || tagNum == 32 || tagNum == 42 || tagNum == 52 || tagNum == 62 || tagNum == 72 || tagNum == 82 || tagNum == 92 || tagNum == 102)
    {
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (tagNum == 11 || tagNum == 21 || tagNum == 31 || tagNum == 41 || tagNum == 51 || tagNum == 61 || tagNum == 71 || tagNum == 81 || tagNum == 91 || tagNum == 101)
    {
        ...
        switch (tagNum) {
            ...
            case 12:{
                txt_1_serial.text = cellDict[@"serial_number"];
            }
                break;
                
            case 22:{
                txt_2_serial.text = cellDict[@"serial_number"];
            }
                break;
                
            case 32:{
                txt_3_serial.text = cellDict[@"serial_number"];
            }
                break;
                
            case 42:{
                txt_4_serial.text = cellDict[@"serial_number"];
            }
                break;
                
            case 52:{
                txt_5_serial.text = cellDict[@"serial_number"];
            }
                break;
                
            case 62:{
                txt_6_serial.text = cellDict[@"serial_number"];
            }
                break;
                
            case 72:{
                txt_7_serial.text = cellDict[@"serial_number"];
            }
                break;
                
            case 82:{
                txt_8_serial.text = cellDict[@"serial_number"];
            }
                break;
                
            case 92:{
                txt_9_serial.text = cellDict[@"serial_number"];
            }
                break;
                
            case 102:{
                txt_10_serial.text = cellDict[@"serial_number"];
            }
                break;
                        ...
                        switch (index) {
                            case 10:{
                                if ([temp[index][@"serial_numbers"]count]!=0) {
                                    ...
                                    self.arr_rt_serial_listing1 = temp[index][@"serial_numbers"];
                                }
                                else{
                            ...
                            case 11:{
                                if ([temp[index][@"serial_numbers"]count]!=0) {
                                    ...
                                    self.arr_rt_serial_listing2 = temp[index][@"serial_numbers"];
                                }
                                else{
                            ...
                            case 12:{
                                if ([temp[index][@"serial_numbers"]count]!=0) {
                                    ...
                                    self.arr_rt_serial_listing3 = temp[index][@"serial_numbers"];
                            ...
                            case 13:{
                                if ([temp[index][@"serial_numbers"]count]!=0) {
                                    ...
                                    self.arr_rt_serial_listing4 = temp[index][@"serial_numbers"];
                            ...
                            case 14:{
                                if ([temp[index][@"serial_numbers"]count]!=0) {
                                    ...
                                    self.arr_rt_serial_listing5 = temp[index][@"serial_numbers"];
                                }
                                else{
                            ...
                            case 15:{
                                if ([temp[index][@"serial_numbers"]count]!=0) {
                                    ...
                                    self.arr_rt_serial_listing6 = temp[index][@"serial_numbers"];
                                }
                                else{
                            ...
                            case 16:{
                                if ([temp[index][@"serial_numbers"]count]!=0) {
                                    ...
                                    self.arr_rt_serial_listing7 = temp[index][@"serial_numbers"];
                                }
                                else{
                            ...
                            case 17:{
                                if ([temp[index][@"serial_numbers"]count]!=0) {
                                    ...
                                    self.arr_rt_serial_listing8 = temp[index][@"serial_numbers"];
                                }
                                else{
                            ...
                            case 18:{
                                if ([temp[index][@"serial_numbers"]count]!=0) {
                                    ...
                                    self.arr_rt_serial_listing9 = temp[index][@"serial_numbers"];
                                }
                                else{
                            ...
                            case 19:{
                                if ([temp[index][@"serial_numbers"]count]!=0) {
                                    ...
                                    self.arr_rt_serial_listing10 = temp[index][@"serial_numbers"];
                                }
                                else{
...
-(void)selectSerialNine:(UIButton*)sender{
    ...
    [self showPopoverDown:sender];
    popoverViewCon.preferredContentSize = CGSizeMake(200,200);
